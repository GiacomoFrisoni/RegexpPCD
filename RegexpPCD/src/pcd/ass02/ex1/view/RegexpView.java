...
public interface RegexpView {
	...
	/**
	 * Updates the mean of files that has at least one match
	 * @param percentage
	...
	/**
	 * Set the number of files that has been succesfully scanned at this moment
	 * @param scanned
	 * 		number of files succesfully scanned
	 */
